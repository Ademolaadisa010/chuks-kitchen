...
import Plantain from "@/public/plantain.png"
      ...
      <main className="flex flex-col md:flex-row w-full min-h-screen">
        ...
        <div className="flex-1 min-h-screen md:pl-20 md:pr-10 px-2 pt-8">
          <nav className="flex-1 flex justify-center md:justify-between items-center">
            ...
            <Link href="/login">
            <button className="hidden md:block border-2 border-[#1E88E5] text-[#1E88E5] px-5 py-1 rounded-lg cursor-pointer">Sign In</button></Link>
          </nav>

          <div className="md:mt-20 mt-2">
            <h2 className={`${inter.className} text-[32px] text-semibold text-[#1F2937]`}>Your Authentic Taste of Nigeria</h2>
          ...
          <div className="mt-10 flex md:flex-row flex-col gap-5 md:gap-30">
          ...
          <p className="text-center hidden md:block my-10 text-[14px] text-[#1F2937]">&copy; 2024 Chuks Kitchen. <Link className="text-[#64B5F6]" href="/">Privacy Policy Terms of Service</Link></p>
        </div>
      </main>
      <Footer/>
    </div>
