            ...
            <main className="flex w-full">
                ...
                <section className="flex-1 flex justify-center bg-white items-center">
                    <div className="w-[60%] min-h-30 pl-2">
                        ...
                        <p className="text-[#000000] text-[24px] text-center ">Create Your Account</p>
                        <form className="mt-6">

                            <label htmlFor="email" className="text-[#3B4758]">Email</label>
                            ...
                            <label htmlFor="email" className="text-[#3B4758]">Phone number</label>
                            <nav className="border-1 mb-3 border-[#BDBDBD] text-black flex items-center pl-4 rounded-sm">
                                <i className="fa-solid fa-phone mr-2"></i>
                                <input type="tel" className="flex-1 h-[40px] border-none outline-none" placeholder="8123340690" />
                            </nav>

                            <label htmlFor="email" className="text-[#3B4758]">Password</label>
                            <nav className="border-1 mb-3 border-[#BDBDBD] text-black flex items-center pl-4 rounded-sm">
                                <i className="fa-solid fa-lock mr-2"></i>
                                <input type="password" className="flex-1 h-[40px] border-none outline-none" placeholder="name@gmail.com" />
                            </nav>

                            <label htmlFor="email" className="text-[#3B4758]">Confirm Password</label>
                            ...
                            <p className="text-[12px] cursor-pointer mt-1 font-400 flex items-center">
                                ...
                                I agree to the  <Link href="/" className="text-[#1E88E5]"> Terms & Conditions and Privacy Policy</Link>
                            </p>
                            ...
                            <p className="text-[14px] text-center mt-2 font-400 mb-5">Already have an account? <Link href="/login" className="text-[#1C7FF9]">Sign In</Link></p>
                        </form>
                    </div>
                </section>
            </main>
